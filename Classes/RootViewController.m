...
- (void)viewDidLoad {
	...
	Next_TrainAppDelegate *appDelegate =
...
-(void)pushStationViewController:(NSArray *)stationArray
	...
	[[StationViewController alloc]
	 initWithNibName:@"StationViewController" bundle:nil];
...
- (void)dealloc {
	[fullStationDictionary release];
	[filteredStationDictionary release];
	[fullSectionIndexTitles release];
	[filteredSectionIndexTitles release];
	[lineImages release];
    [super dealloc];
}
